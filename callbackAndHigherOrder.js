...
const calculator = (num1, num2, callback) => {
  if(+num1 && +num2){
      ...
      return "You did not enter valid numbers."
  }
}
...
// CODE HERE
function newFunction(uniqArr){
  console.log(`The new names array with all the duplicate items remobed is ${uniqArr}`)
}


uniq(names, newFunction)
