...
/////////CODE HERE/////////
let afterTax = prices.map(price => price * 1.07)
...
// CODE HERE
// const bobsPurchaseList = purchases.filter(purchase => {
//   if (purchase.owner === "Bob"){
//     let bobsTotal = bobsPurchaseList.reduce((previousValue, currentValue) => previousValue + currentValue)
//     return bobsTotal
//   }
//   return bobsTotal
// })

const bobsOrders = purchases.filter(purchase => purchase.owner === "Bob")
const bobsTotal = bobsOrders.reduce((previousValue, currentValue) => previousValue + currentValue.price, 0)
